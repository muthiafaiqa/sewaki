...
## Corpus Check
- 50 files · ~18,998 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 321 nodes · 345 edges · 31 communities (22 shown, 9 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4a90c474`
...
- [[_COMMUNITY_Transaction Flow Routing|Transaction Flow Routing]]
...
- `disburse()` --calls--> `sendEmail()`  [EXTRACTED]
  src/modules/payment/payment.controller.js → src/modules/notification/notification.service.js
...
Cohesion: 0.08
Nodes (20): bcrypt, jwt, prisma, register(), { sendEmail }, nodemailer, sendEmail(), transporter (+12 more)

### Community 1 - "Inventory and Transactions"
Cohesion: 0.09
Nodes (14): prisma, { reduceStock, restoreStock }, prisma, reduceStock(), restoreStock(), createTransaction(), { payTransaction }, prisma (+6 more)
...
Cohesion: 0.12
Nodes (16): author, description, devDependencies, nodemon, prisma, keywords, license, main (+8 more)
...
Cohesion: 0.12
Nodes (10): jwt, express, prisma, router, { sendEmail }, verifyToken, express, paymentController (+2 more)
...
### Community 11 - "Transaction Flow Routing"
Cohesion: 0.20
...
Cohesion: 0.14
Nodes (14): dependencies, axios, bcrypt, cors, dotenv, express, jsonwebtoken, multer (+6 more)
...
- **Why does `sendEmail()` connect `Core Business Operations` to `Route Security Middleware`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Community 24` to `Project Configuration and Scripts`?**
